...
int main(int argc, char* argv[])
{
	...
	// Connect via a UDPClient socket to a outstation
	auto pChannel = manager.AddUDPClient("clientUDP", FILTERS, ChannelRetry::Default(), "127.0.0.1", "0.0.0.0", 20000);
