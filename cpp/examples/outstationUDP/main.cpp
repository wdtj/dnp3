...
int main(int argc, char* argv[])
{
	...
	auto channel = manager.AddUDPServer("serverUDP", FILTERS, ChannelRetry::Default(), "0.0.0.0", 20000);
	...
	auto outstation = channel->AddOutstation("outstationUDP", SuccessCommandHandler::Instance(), DefaultOutstationApplication::Instance(), stackConfig);
